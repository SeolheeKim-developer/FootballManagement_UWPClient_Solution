...
namespace FootballManagement_UWPClient.Utilities
{
    public static class Jeeves
    {
        //For Local API
        //public static Uri DBUri = new Uri("https://localhost:7097/");

        //For Azure
        public static Uri DBUri = new Uri("https://footballmanagement.azurewebsites.net");
